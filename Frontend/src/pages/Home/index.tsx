...
// FadeInSection now also scales from 0.95 to 1 as it comes into view.
  ...
  return (
    <div className="min-h-screen bg-dark-blue relative overflow-hidden">
      ...
      <div className="relative pt-16">
        ...
        <motion.div
          style={{ y: parallax }}
          className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-code-green/5 rounded-full blur-[120px] -z-10"
        ></motion.div>
      ...
      <FadeInSection>
        <div className="container mx-auto px-4 py-20 relative">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">How TalentLink Works</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Post Project", description: "Share your project details and requirements" },
              { step: "02", title: "Get Proposals", description: "Receive proposals from skilled freelancers" },
              { step: "03", title: "Choose & Hire", description: "Select the best freelancer for your project" },
              { step: "04", title: "Complete Project", description: "Work together and get your project done" },
            ].map((item, index) => (
            ...
            {[
              {
                ...
                quote: "TalentLink made it incredibly easy to find talented developers. The quality of work exceeded our expectations.",
              },
              {
                name: "Michael Chen",
                ...
                quote: "As a freelancer, I've found amazing opportunities through TalentLink. The platform is intuitive and client communication is seamless.",
              },
              {
                name: "Emily Davis",
