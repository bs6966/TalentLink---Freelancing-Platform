        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              These terms and conditions outline the rules and regulations for the use of TalentLink's website.
            </p>
          </section>
          <section>
            <h2 className="text-2xl font-semibold mb-4">2. Intellectual Property Rights</h2>
            <p className="text-gray-300 leading-relaxed">
              Other than the content you own, under these Terms, TalentLink and/or its licensors own all the intellectual property rights and materials contained in this Website.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              In no event shall TalentLink, nor any of its officers, directors, and employees, be held liable for anything arising out of or in any way connected with your use of this Website.
            </p>
          </section>
          <section>
            <h2 className="text-2xl font-semibold mb-4">5. Variation of Terms</h2>
            <p className="text-gray-300 leading-relaxed">
            TalentLink is permitted to revise these Terms at any time as it sees fit, and by using this Website you are expected to review these Terms on a regular basis.
            </p>
          </section>
        </div>
      </div>
